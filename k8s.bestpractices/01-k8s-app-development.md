...
- Minimal container images are faster to build, push, deploy, and start. The smaller the container, 
...
- Set resource limits so that your applications almost, but don’t quite exceed them in normal usage.
  Don’t allocate more cloud storage than you need, and don’t provision high-bandwidth storage unless it’s critical 
