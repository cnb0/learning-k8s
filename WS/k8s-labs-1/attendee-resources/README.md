...
04. Rollouts 
             - Retreat! - Create a canary deployment with a bad image and then rollback
             - Ready or Not - Use readiness and liveness probes

05. Storage  - Destroy the database pod

06. Security - Configure our MySQL pods with Secrets and config maps

07. Logging  - Logging & Monitoring
