...
II. Behavioral Patterns
      ...
      13. Self Awareness
                   - Using the Downward API for setting environment variables and mount resource fields
                     as files with the random-generator service
...
IV. Configuration Patterns
      18. EnvVar Configuration
                - A simple example of how to use environment variables literally and from ConfigMaps and 
                  Secrets for random-generator service        
...
V. Advanced Patterns
      ...
      22. Controller
              ...
              - An additional example controller exposes an ingress route when it detects an 
                exposeService label attached to the service.
